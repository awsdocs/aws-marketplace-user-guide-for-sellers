...
## Pricing your software<a name="w454aac24c16c15"></a>
...
[Adding your product to AWS Marketplace](custom-metering-pricing-ami-products.md#listing-your-product-on-aws-marketplace) describes how to provide a customer\-friendly description of your dimension and pricing\. 

### Example: Provisioned bandwidth with nonlinear pricing<a name="w454aac24c16c15c13"></a>
...
### Example: Concurrent hosts with multiple dimensions<a name="w454aac24c16c15c15"></a>
...
Products that use multiple SaaS products and the Clusters and AWS Resources feature can't use the AWS Marketplace Metering Service\. 
...
## Modifying your software to use the Metering Service<a name="w454aac24c16c19"></a>
...
### Measuring consumption<a name="w454aac24c16c19b5"></a>
...
For pricing on multiple dimensions, multiple values must be measured and sent to the Metering Service, one per dimension\. This requires your software to be programmed or configured with the known set of dimensions when you provide the SaaS product\. The set of dimensions can't change after a product is created\.
...
## Vendor\-metered tagging \(Optional\)<a name="w454aac24c16c21"></a>
...
### Seller experience<a name="w454aac24c16c21b9"></a>
...
### Buyer experience<a name="w454aac24c16c21c11"></a>
