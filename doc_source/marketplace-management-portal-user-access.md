...
After you create users, you create groups, create permissions to access the pages in AWS Marketplace Management Portal, add those permissions to the groups, and then add users to the groups\.
...
For details about the AWS Marketplace Management Portal permissions, see [Permissions Details for AWS Marketplace Management Portal](#detailed-management-portal-permissions)\.
...
1. On the **Edit Permissions** page, do the following:
   ...
   1. For **Actions**, select the permission\(s\) to allow\. To learn what each permission allows a user to do in the AWS Marketplace Management Portal, go to [Permissions Details for AWS Marketplace Management Portal](#detailed-management-portal-permissions)\.
...
1. On the **Review Policy** page, do the following:
   ...
   1. For **Policy Name**, type a name for this policy\. Take note of the policy name because you will need it for a later step\.
...
## Signing in to AWS Marketplace Management Portal as an IAM User<a name="signing-in-using-iam-user"></a>

After you've created users in IAM, users can sign in with their own user names and passwords\. To do so, they need to use the unique URL that is associated with your AWS account\. You can get and distribute the sign\-in URL to your users\.
...
## Permissions Details for AWS Marketplace Management Portal<a name="detailed-management-portal-permissions"></a>
...
To allow a user access to the Manage Products page, you must allow full access\. The Manage Products page does not currently have its own permission that you can allow separately from the others\.
