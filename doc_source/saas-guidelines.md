...
+ You must call the AWS Marketplace APIs from the AWS account that registered as a seller and submitted the SaaS publishing request\. The SaaS pricing model determines which APIs should be called:
